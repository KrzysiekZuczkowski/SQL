...
-----------------------------------------------------------------------
--TABELA SPRZEDAWA£ GOTOWA
--SELECT X.Imie,X.Nazwisko,X.Zatrudniony,X.id_S,X.W_Kasie,KY.Na_Dworcu FROM Kasy KY INNER JOIN 
--(SELECT KS.Imie,KS.Nazwisko,KS.Zatrudniony,SP.id_S,SP.W_Kasie FROM Kasjer_Sprzedawca  KS INNER JOIN 
--Sprzedawal SP ON KS.id_K_S = SP.Kasjer )   X    ON KY.Kasa = X.W_Kasie
---------------------------------------------------------------------- 
-----------------------------------------------------------------------
--TABELA POCI¥G GOTOWA 
--SELECT POC.Numer,POC.Wyjechal,B.Z,B.DO,B.Typ,B.Cena_za_1km_KL1,B.Cena_za_1km_KL2,B.Kategoria FROM Pociag POC INNER JOIN
--(SELECT ZP.Z,ZP.DO, A.Typ,A.Cena_za_1km_KL1,A.Cena_za_1km_KL2,A.Kategoria,A.id_P FROM Zestaw_Polaczen ZP INNER JOIN
--(SELECT TP.Typ,TP.Cena_za_1km_KL1,TP.Cena_za_1km_KL2,TP.Kategoria,POL.id_P,POL.id_Zes_Pol FROM 
--Typ_Polaczen TP INNER JOIN Polaczenie POL ON TP.Typ = POL.id_Typ_Pol) A ON ZP.id_Z_P=A.id_Zes_Pol) B ON
--POC.id_Polaczenia = B.id_P
-----------------------------------------------------------------------
--TABELA DOJADE GOTOWA

--SELECT CP.Skad,CP.Dokad,CP.Odleglosc_w_km,D.id_D,D.Numer,D.Wyjechal,D.Z,D.DO,D.Typ,D.Cena_za_1km_KL1,
--D.Cena_za_1km_KL2,D.Kategoria FROM Cel_Podrozy CP INNER JOIN 
--(SELECT DOJ.id_D,DOJ.id_Cel,C.Numer,C.Wyjechal,c.Z,C.DO,C.Typ,C.Cena_za_1km_KL1,C.Cena_za_1km_KL2,
--C.Kategoria FROM Dojade DOJ INNER JOIN 
--(SELECT POC.Numer,POC.Wyjechal,B.Z,B.DO,B.Typ,B.Cena_za_1km_KL1,B.Cena_za_1km_KL2,B.Kategoria FROM Pociag POC INNER JOIN
--(SELECT ZP.Z,ZP.DO, A.Typ,A.Cena_za_1km_KL1,A.Cena_za_1km_KL2,A.Kategoria,A.id_P FROM Zestaw_Polaczen ZP INNER JOIN
--(SELECT TP.Typ,TP.Cena_za_1km_KL1,TP.Cena_za_1km_KL2,TP.Kategoria,POL.id_P,POL.id_Zes_Pol FROM 
--Typ_Polaczen TP INNER JOIN Polaczenie POL ON TP.Typ = POL.id_Typ_Pol)  A  ON ZP.id_Z_P=A.id_Zes_Pol)  B  ON
--POC.id_Polaczenia = B.id_P)   C  ON DOJ.Pociagiem = C.Numer )  D   ON CP.id_C_P = D.id_Cel 
--WHERE CP.Skad = 'Poznañ G³ówny'--D.Wyjechal BETWEEN CAST('05:00:00' AS TIME) AND CAST('12:00:00' AS TIME)
-------------------------------------------------------------------------
--TABELA POZYCJE BILETU GOTOWA
--SELECT F.id_Biletu,F.id_Poz,F.id_Znizki,ZN.Ile_procent,F.Liczba_Podroznych,F.Skad,F.Dokad,F.Odleglosc_w_km,
--F.Numer,F.Wyjechal,F.Z,F.DO,F.Typ,F.Cena_za_1km_KL1,F.Cena_za_1km_KL2,F.Kategoria FROM Znizka ZN RIGHT JOIN 
--(SELECT PBI.id_Biletu,PBI.id_Poz,PBI.id_Znizki,PBI.Liczba_Podroznych,E.Skad,E.Dokad,E.Odleglosc_w_km,
--E.Numer,E.Wyjechal,E.Z,E.DO,E.Typ,E.Cena_za_1km_KL1,E.Cena_za_1km_KL2,E.Kategoria FROM  Poz_Biletu PBI INNER JOIN  
--(SELECT CP.Skad,CP.Dokad,CP.Odleglosc_w_km,D.id_D,D.Numer,D.Wyjechal,D.Z,D.DO,D.Typ,D.Cena_za_1km_KL1,
--D.Cena_za_1km_KL2,D.Kategoria FROM Cel_Podrozy CP INNER JOIN 
--(SELECT DOJ.id_D,DOJ.id_Cel,C.Numer,C.Wyjechal,c.Z,C.DO,C.Typ,C.Cena_za_1km_KL1,C.Cena_za_1km_KL2,
--C.Kategoria FROM Dojade DOJ INNER JOIN 
...
--(SELECT TP.Typ,TP.Cena_za_1km_KL1,TP.Cena_za_1km_KL2,TP.Kategoria,POL.id_P,POL.id_Zes_Pol FROM 
--Typ_Polaczen TP INNER JOIN Polaczenie POL ON TP.Typ = POL.id_Typ_Pol)  A  ON ZP.id_Z_P=A.id_Zes_Pol)  B  ON
--POC.id_Polaczenia = B.id_P)   C  ON DOJ.Pociagiem = C.Numer )  D   ON CP.id_C_P = D.id_Cel)   E  ON 
--PBI.id_Dojade = E.id_D)   F ON ZN.Nazwa = F.id_Znizki
-------------------------------------------------------------------------
 
--SELECT H.id_Biletu,H.id_Poz,H.Data_Podrozy,H.Data_Sprzedazy,H.id_Znizki [Nazwa Znizki],H.Ile_procent,
--H.Liczba_Podroznych,H.Skad,H.Dokad,H.Odleglosc_w_km,H.Numer,H.Wyjechal,H.Z,H.DO,H.Typ,H.Cena_za_1km_KL1,
--H.Cena_za_1km_KL2,H.Kategoria, J.Imie,J.Nazwisko,J.Zatrudniony,J.W_Kasie,J.Na_Dworcu 
--FROM 
--(SELECT X.Imie,X.Nazwisko,X.Zatrudniony,X.id_S,X.W_Kasie,KY.Na_Dworcu 
--FROM Kasy KY INNER JOIN 
--(SELECT KS.Imie,KS.Nazwisko,KS.Zatrudniony,SP.id_S,SP.W_Kasie 
--FROM Kasjer_Sprzedawca  KS INNER JOIN 
--Sprzedawal SP   ON KS.id_K_S = SP.Kasjer 
--)  X  ON  KY.Kasa = X.W_Kasie
--)  J 
--RIGHT JOIN
--(SELECT BT.id_Sprzedane,BT.Data_Podrozy,BT.Data_Sprzedazy,G.id_Biletu,G.id_Poz,G.id_Znizki,G.Ile_procent,
--G.Liczba_Podroznych,G.Skad,G.Dokad,G.Odleglosc_w_km,G.Numer,G.Wyjechal,G.Z,G.DO,G.Typ,G.Cena_za_1km_KL1,
--G.Cena_za_1km_KL2,G.Kategoria 
--FROM Bilet BT INNER JOIN  
--(SELECT F.id_Biletu,F.id_Poz,F.id_Znizki,ZN.Ile_procent,F.Liczba_Podroznych,F.Skad,F.Dokad,F.Odleglosc_w_km,
--F.Numer,F.Wyjechal,F.Z,F.DO,F.Typ,F.Cena_za_1km_KL1,F.Cena_za_1km_KL2,F.Kategoria 
--FROM Znizka ZN RIGHT JOIN 
--(SELECT PBI.id_Biletu,PBI.id_Poz,PBI.id_Znizki,PBI.Liczba_Podroznych,E.Skad,E.Dokad,E.Odleglosc_w_km,
--E.Numer,E.Wyjechal,E.Z,E.DO,E.Typ,E.Cena_za_1km_KL1,E.Cena_za_1km_KL2,E.Kategoria 
--FROM  Poz_Biletu PBI INNER JOIN  
--(SELECT CP.Skad,CP.Dokad,CP.Odleglosc_w_km,D.id_D,D.Numer,D.Wyjechal,D.Z,D.DO,D.Typ,D.Cena_za_1km_KL1,
--D.Cena_za_1km_KL2,D.Kategoria 
--FROM Cel_Podrozy CP INNER JOIN 
--(SELECT DOJ.id_D,DOJ.id_Cel,C.Numer,C.Wyjechal,c.Z,C.DO,C.Typ,C.Cena_za_1km_KL1,C.Cena_za_1km_KL2,
--C.Kategoria 
--FROM Dojade DOJ INNER JOIN 
--(SELECT POC.Numer,POC.Wyjechal,B.Z,B.DO,B.Typ,B.Cena_za_1km_KL1,B.Cena_za_1km_KL2,B.Kategoria 
--FROM Pociag POC INNER JOIN
--(SELECT ZP.Z,ZP.DO, A.Typ,A.Cena_za_1km_KL1,A.Cena_za_1km_KL2,A.Kategoria,A.id_P 
--FROM Zestaw_Polaczen ZP INNER JOIN
--(SELECT TP.Typ,TP.Cena_za_1km_KL1,TP.Cena_za_1km_KL2,TP.Kategoria,POL.id_P,POL.id_Zes_Pol 
--FROM Typ_Polaczen TP INNER JOIN 
--Polaczenie POL   ON TP.Typ = POL.id_Typ_Pol
--)   A   ON ZP.id_Z_P = A.id_Zes_Pol
--)   B   ON POC.id_Polaczenia = B.id_P
--)   C   ON DOJ.Pociagiem = C.Numer
...
--)   F   ON ZN.Nazwa = F.id_Znizki
--)   G   ON  BT.id_B = G.id_Biletu
--)   H   ON J.id_S = H.id_Sprzedane ORDER BY H.id_Biletu